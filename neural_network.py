...
def conclusions_page():
    ...
    **Распределение процента выброса:** Наблюдается отрицательная корреляция с полом (-0.15) и фактом курения пациента 
    (-0.07), что может указывать на более высокий процент выброса крови у куряших пациентов и пациентов-мужчин.
    ...
    **Распределение времени:** Выявляется слабая отрицательная корреляция с возрсатом (-0.22) и с повышенным давлением 
    (-0.20), что может указывать на меньшее время наблюдения у более пожилых пациентов и пациентов с повышенным 
    давлением.
    """)
